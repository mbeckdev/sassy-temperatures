    ...
    <div className="w-full max-w-6xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-center text-gray-600 mb-6">
          Temperature conversions with attitude for low humidity areas
        </p>
          ...
          <table className="w-full">
            ...
            <tbody>
              {filteredData.map((item, index) => (
                ...
                >
                  <td className="px-6 py-4 font-mono text-lg font-semibold text-blue-600">
                    {item.fahrenheit}°F
                  </td>
                  <td className="px-6 py-4 font-mono text-lg font-semibold text-green-600">
                    {item.celsius}°C
                  </td>
